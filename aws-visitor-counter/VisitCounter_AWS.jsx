...
// IMPORTANT: Replace this with your actual Lambda API Gateway URL after deployment
const LAMBDA_API_URL = 'https://YOUR-API-ID.execute-api.YOUR-REGION.amazonaws.com/default/PortfolioVisitorCounter';
